...
add_action('wp_enqueue_scripts', function () {
    ...
    if(is_page('contact')) {
        wp_enqueue_script('google-maps', "https://maps.googleapis.com/maps/api/js?key=AIzaSyAhv4kCi2_Cl7Xqgcxs3tIWd96vOHDvFGI", [], null, true);
    }

    wp_enqueue_style('fonts/adobe', 'https://use.typekit.net/msr3oye.css', [], null);
    wp_enqueue_style('wp/block', '/wp-includes/css/dist/block-library/style.min.css', false, null);
